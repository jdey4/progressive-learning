...
for ii, data in enumerate(tes_all.keys()):
    ...
    ax_ = sns.stripplot(x='Algorithms', y='Forward Transfer Efficieny', data=ftes_all[data], hue='Algorithms', palette=clr_, ax=ax[0], size=20, legend=None, alpha=.3)
    ax_.set_xticklabels(
    labels[ii],
    ...
    ax_ = sns.stripplot(x='Algorithms', y='Backward Transfer Efficieny', data=btes_all[data], hue='Algorithms', palette=clr_, ax=ax[1], size=20, legend=None, alpha=.3)
    ax_.set_xticklabels(
    labels[ii],
    fontsize=font,rotation=65,ha="right",rotation_mode='anchor'
    )
    ...
    ax_ = sns.stripplot(x='Algorithms', y='Transfer Efficieny', data=tes_all[data], hue='Algorithms', palette=clr_, ax=ax[2], size=20, legend=None, alpha=.3)
