...
with open('./result/mean_xor_nxor_replay.pickle','wb') as f:
    pickle.dump(mean_error,f)
    
with open('./result/std_xor_nxor_replay.pickle','wb') as f:
    pickle.dump(std_error,f)
    
with open('./result/mean_te_xor_nxor_replay.pickle','wb') as f:
    pickle.dump(mean_te,f)
    
with open('./result/std_te_xor_nxor_replay.pickle','wb') as f:
    pickle.dump(std_te,f)

#%% Plotting the result
#mc_rep = 50
mean_error = unpickle('result/mean_xor_nxor_replay.pickle')
std_error = unpickle('result/std_xor_nxor_replay.pickle')
...
#####
mean_error = unpickle('result/mean_te_xor_nxor_replay.pickle')
std_error = unpickle('result/std_te_xor_nxor_replay.pickle')
...
ax.axis('off')
#plt.tight_layout()
plt.savefig('./result/figs/xor_nxor_replay_exp.pdf')
